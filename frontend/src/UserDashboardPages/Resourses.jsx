  ...
  return (
    <Box
      sx={{
        ...
        alignItems: "center",
        gap: 5, // Add gap between sections for better spacing
    ...
    >
      ...
      <Typography
        ...
        sx={{
          ...
          letterSpacing: "1px", // Added spacing for clarity
        }}
      >
      ...
      >
        <ArticleIcon color="primary" sx={{ fontSize: 30 }} /> Latest Mental Health News
      </Typography>
          ...
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card
              sx={{
                maxWidth: 345,
                borderRadius: "16px",
                boxShadow: "0 4px 20px rgba(0,0,0,0.1)", // Subtle shadow effect
                transition: "0.3s",
                "&:hover": {
                  transform: "scale(1.05)",
                  boxShadow: "0 8px 30px rgba(0,0,0,0.2)", // Stronger hover effect
                },
              }}
            >
