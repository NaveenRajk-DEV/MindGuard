...
export default function DataInsights() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/api/explore?category=data")
      .then((res) => {
        setDataInsights(res.data);
        setLoading(false);
      })
      .catch((err) => {
    ...
    >
      ...
      <div className="mt-8 text-center">
        <button
          ...
          className="px-6 py-3 bg-purple-600 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-purple-700 transition duration-200"
        >
          🔙 Back to Explore
        </button>
      </div>
